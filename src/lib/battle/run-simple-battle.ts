/**
 * spec/020_test_battle.md - 1v3 簡易戦闘ループ（通常攻撃のみ）
 * 行動順・ターゲット抽選（列ウェイト）・命中・直撃/致命・ダメージ・疲労・MP回復
 */
...
/**
 * 1v3 簡易戦闘。主人公 vs 敵3体。ターゲットは列ウェイトで抽選。
 */
export function runSimpleBattleLoop(
